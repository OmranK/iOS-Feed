...
class RemoteImageLoader {
    ...
    func loadImageData(from url: URL, completion: @escaping (ImageLoader.Result) -> Void) {
...
class LoadImageFromRemoteUseCaseTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteImageLoader, toCompleteWith expectedResult: ImageLoader.Result, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
        let url = URL(string: "https://a-given-url.com")!
