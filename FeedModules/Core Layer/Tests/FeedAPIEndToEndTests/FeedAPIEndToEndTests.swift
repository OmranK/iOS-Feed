...
//
//  Created by Omran Khoja on 2/7/22.
//
...
class FeedAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> ImageLoader.Result? {
        let loader = RemoteImageLoader(client: ephemeralClient())
        trackForMemoryLeaks(loader, file: file, line: line)
