...
import FeediOS
@testable import FeedApplication

class FeedApplicationAcceptanceTests: XCTestCase {
    ...
    func test_onLaunch_displaysCachedFeedWhenCustomerHasNoConnectivity() {
        ...
        onlineFeed.simulateVisibleImageView(at: 0)
        onlineFeed.simulateVisibleImageView(at: 1)
    ...
    func test_onLaunch_displaysEmptyFeedWhenCustomerHasNoConnectivityAndNoCache() {
        let feed = launch(httpClient: .offline, store: InMemoryFeedStore.empty)
    ...
    private class InMemoryFeedStore: FeedStore, ImageStore {
