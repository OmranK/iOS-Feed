...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func assertThatInsertOverridesExistingCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        insert((uniqueImageFeed().local, Date()), to: sut)
    ...
    func assertThatDeleteRemovesExistingNonEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        insert((uniqueImageFeed().local, Date()), to: sut)
